...
return [
    ...
    */
    ...
    'required_without_all' => 'Bidang :attribute wajib diisi ketika tidak ada :values yang hadir.',
    'same' => 'Bidang :attribute dan :other harus cocok.',
    'size' => [
        'array' => 'Bidang :attribute harus mengandung :size item.',
        'file' => 'Bidang :attribute harus sebesar :size kilobyte.',
        'numeric' => 'Bidang :attribute harus sebesar :size.',
        'string' => 'Bidang :attribute harus sebesar :size karakter.',
    ],
